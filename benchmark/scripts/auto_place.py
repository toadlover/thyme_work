...
#these files are now located in /data/project/thymelab/running_Rosetta/ari_work/REU_shared_space/benchmark/files named "d"_ignorechain_condensed_motif_list_08_06_21.motifs

#using 2022 motif list
-motif_filename """ + "/data/project/thymelab/running_Rosetta/ari_work/REU_shared_space/benchmark/files/" + d + "_ignorechain_spliced_list_duplicates_removed_october_2022.motifs" """
#using 2021 motif list
#-motif_filename """ + "/data/project/thymelab/running_Rosetta/ari_work/REU_shared_space/benchmark/files/" + d + "_ignorechain_condensed_motif_list_08_06_21.motifs" """
#old
#-motif_filename """ + loc1 + """
...
loc2 + """/main/source/bin/ligand_discovery_search_protocol.linuxgccrelease @""" + p.split("disc_out/", 1)[1] + "_args" + """
